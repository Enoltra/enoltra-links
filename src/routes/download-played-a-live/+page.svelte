<script>
  ...
  function handleFollowClick(url, platform) {
    ...
    track('FreeDownloadFollow', { song: 'Played-A-Live (Enoltra Bootleg)', platform });
  }
  ...
  function goToDownloadStep() {
    ...
    track('FreeDownloadComplete', { song: 'Played-A-Live (Enoltra Bootleg)' });
  }
  ...
  $: if (step === 2) {
    ...
    track('FreeDownloadEmailSubmit', { song: 'Played-A-Live (Enoltra Bootleg)' });
  }
</script>

<svelte:head>
  <title>Download: Played-A-Live (Enoltra Bootleg)</title>
...
<div class="gate-container">
  ...
  <div class="content-wrapper">
    <header class="gate-header">
      <h1 class="main-title">Played-A-Live (Enoltra Bootleg)</h1>
    </header>
...
<style>
  :global(body) { background-color: #2B2FC6; }
  .gate-container {
    width: 100%;
    min-height: 100vh;
    background-image: url('/played-a-live-bg.webp');
  ...
  .footer-prompt-wrapper { width: 100%; text-align: center; margin-top: 6rem; }
  .download-prompt {
    background: none;
    border: none;
    padding: 0;
